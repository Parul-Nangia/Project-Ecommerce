...
//                    }}/>
//             </Form.Item>
//             <Form.Item label="Father Name" rules={[{ type: "text" }]}>
//               <Input
//               value={fatherName}
//               onChange={(e) => {
//                 setFatherName(() => {
...
//               </Select>
//             </Form.Item>
//             <Form.Item label="Emergency Contact Number" rules={[{ type: "number" }]}>
//               <Input 
//               value={contactNumber}
//               onchange={(e)=>{
//                 setContactNumber(()=>{
...
//           </Col>
//         </Row>
//         <Row justify="center"><Button onClick={SubmitOne}>submit</Button></Row>
...
const Profile = () => {;
  ...
  const Submithere =(e)=>{
    ...
    axios.put(`${process.env.REACT_APP_BASE_URL}/${id}`,
